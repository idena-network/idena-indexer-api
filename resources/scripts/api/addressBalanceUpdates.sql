SELECT bu.id,
       ...
       coalesce(bu.penalty_seconds_old, 0)               penalty_seconds_old,
       bu.balance_new,
       bu.stake_new,
       coalesce(bu.penalty_new, 0)                       penalty_new,
       coalesce(bu.penalty_seconds_new, 0)               penalty_seconds_new,
       coalesce(bu.penalty_payment, 0)                   penalty_payment,
       dicr.name                                         reason,
