SELECT coalesce(ei.short_point, 0)                                    short_point,
       ...
       coalesce(vrs.extra_flips, 0)                                   extra_flips,
       coalesce(vrs.extra_flips_missed, 0)                            extra_flips_missed,
       coalesce(vrs.extra_flips_missed_reason, 0)                     extra_flips_missed_reason,
       ...
       coalesce(vrs.invitee, 0)                                       invitee,
       coalesce(vrs.invitee_missed, 0)                                invitee_missed,
       coalesce(vrs.invitee_missed_reason, 0)                         invitee_missed_reason,
